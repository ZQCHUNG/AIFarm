...
| Sprint | 名稱 | 優先級 | 功能 | 說明 |
|--------|------|--------|------|------|
| 22 | 大修復與無限家園 | P0 | 確定性巨型地圖 | Seeded PRNG 大地圖（256x256）、固定地標（溫泉/遺跡）、山壁邊界 |
| 22 | 大修復與無限家園 | P1 | Z-Sorting 深度重構 | 底部中心點排序、實體遮蔽修復、NPC 尺寸穩定 |
| 22 | 大修復與無限家園 | P1 | 室內轉場系統 | DoorTrigger 門觸發、黑屏漸變、室內地圖切換 |
| 22 | 大修復與無限家園 | P2 | 實體動畫校準 | 動畫幀率配合移動速度、IDLE 狀態正確切換 |

### 待辦（路線圖）

| 階段 | Sprint | 優先級 | 功能 | 說明 |
|------|--------|--------|------|------|
| 6 | TBD | P1 | 科技樹升級 | 工具效率升級系統、研究進度 |
| 6 | TBD | P2 | 房屋自訂 | 玩家房屋內部裝潢系統 |
| 6 | TBD | P1 | AI 廣播板 | NPC 即時評論 git commit |
| 6 | TBD | P2 | 貿易與外交 | 跨專案資源交易模擬 |
